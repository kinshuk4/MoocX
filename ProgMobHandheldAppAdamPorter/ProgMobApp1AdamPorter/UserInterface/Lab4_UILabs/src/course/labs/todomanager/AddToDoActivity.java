	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Priority priority = getPriority();//Priority.values()[mPriorityRadioGroup.indexOfChild(findViewById(mPriorityRadioGroup.getCheckedRadioButtonId()))];

				// DONE - Get the current Status
				Status status = getStatus(); // Status.values()[mStatusRadioGroup.indexOfChild(findViewById(mStatusRadioGroup.getCheckedRadioButtonId()))];;
