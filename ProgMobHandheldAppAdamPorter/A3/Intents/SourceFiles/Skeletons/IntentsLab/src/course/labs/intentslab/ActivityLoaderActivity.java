...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		// COMPLETED - Create a new intent to launch the ExplicitlyLoadedActivity class
		Intent intent = new Intent(ActivityLoaderActivity.this,ExplicitlyLoadedActivity.class);
		// COMPLETED - Start an Activity using that intent and the request code defined above
	...
	private void startImplicitActivation() {
		...
		// COMPLETED - Create a base intent for viewing a URL 
		// (HINT:  second parameter uses parse() from the Uri class)
		Uri link = Uri.parse(URL);
		Intent implicitIntent = new Intent(Intent.ACTION_VIEW, link);		
		
		// COMPLETED - Create a chooser intent, for choosing which Activity
		// will carry out the baseIntent. Store the Intent in the 
		// chooserIntent variable below. HINT: using the Intent class' 
		// createChooser())
		
		Intent chooserIntent = null;
		chooserIntent = Intent.createChooser(implicitIntent, "Load " + URL);
		Log.i(TAG,"Chooser Intent Action:" + chooserIntent.getAction());
		// COMPLETED - Start the chooser Activity, using the chooser intent
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		// COMPLETED - Process the result only if this method received both a
