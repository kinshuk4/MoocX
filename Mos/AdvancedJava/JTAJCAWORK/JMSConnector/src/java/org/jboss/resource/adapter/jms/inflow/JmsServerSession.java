...
public class JmsServerSession implements ServerSession, MessageListener, Work, WorkListener {
    ...
    public void setup() throws Exception {
        ...
        // Create the session
        System.out.println("connection instanceof XAConnection:"+(connection instanceof XAConnection)+" activation.isDeliveryTransacted():"+(activation.isDeliveryTransacted()+
                " spec.isSessionTransacted():"+(spec.isSessionTransacted())));
    ...
    private class LocalDemarcationStrategy implements TransactionDemarcationStrategy {
        ...
        public LocalDemarcationStrategy() {
            System.out.println("LocalDemarcationStrategy");
        }
            ...
            if (spec.isSessionTransacted()) {
                if (session != null) {
                    try {
                         ...
                         *
                         */
                        System.out.println("isDeliveryTransacted():"+pool.getActivation().isDeliveryTransacted()+" spec.getRedeliverUnspecified():"+spec.getRedeliverUnspecified());
    ...
    private class XATransactionDemarcationStrategy implements TransactionDemarcationStrategy {
        ...
        public XATransactionDemarcationStrategy() throws Throwable {
            System.out.println("XATransactionDemarcationStrategy()");
            ...
            try {
                ...
                if (xaSession != null) {
                    XAResource res = new XAWrapper(xaSession.getXAResource());
