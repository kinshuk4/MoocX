...
public final class ClassLoaderRepositorySupport 
    ...
    private final Class loadClass(final LoaderEntry list[], 
    ...
    private final synchronized void startValidSearch(ClassLoader aloader,
						     String className) 
        throws ClassNotFoundException {
    ...
    private final synchronized void stopValidSearch(ClassLoader aloader,
						    String className) {
