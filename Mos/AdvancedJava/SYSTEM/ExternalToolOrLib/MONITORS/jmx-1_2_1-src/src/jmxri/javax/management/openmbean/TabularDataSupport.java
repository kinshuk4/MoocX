...
public class TabularDataSupport 
   ...
   public int hashCode() { 
     ...
     * <tt>dataMap.{@link <a href="http://java.sun.com/j2se/1.3/docs/api/java/util/HashMap.html#toString()">toString()</a>}</tt>).
     * 
