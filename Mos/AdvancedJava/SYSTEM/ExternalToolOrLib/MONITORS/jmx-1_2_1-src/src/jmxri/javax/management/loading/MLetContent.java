 ...
 */
 class MLetContent {
     ...
     *
     * @param <VAR>url</VAR> The URL of the MLet text file containing the <CODE>MLET</CODE> tag.
     * @param <VAR>attributes</VAR> A list of the attributes of the <CODE>MLET</CODE> tag.
     */
     ...
     * attribute of the <CODE>MLET</CODE> tag.
     *
     * @param <VAR>name</VAR> A string representing the name of the attribute.
