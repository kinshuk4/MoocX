...
public abstract class ForwardingMBeanServerInterceptor implements MBeanServerInterceptor {
     ...
     * <code>this</code>.
     */
    public synchronized void setNextInterceptor(MBeanServerInterceptor next)
     ...
     * SunJmxMBeanServer}.  Requests will be forwarded to the {@link
     * MBeanServerInterceptor} that was previously the default
     ...
     * interceptors.
     */
    public void insertFirst(SunJmxMBeanServer lmbs)
	    throws NullPointerException, InterceptorCycleException {
	synchronized (lmbs) {
     ...
     * SunJmxMBeanServer}.  A chain of interceptors is defined here as
     * a list of {@link ForwardingMBeanServerInterceptor} objects,
     * starting with <code>lmbs.</code>{@link
     * SunJmxMBeanServer#getMBeanServerInterceptor()
     ...
     * interceptors.
     */
    public void insertLast(SunJmxMBeanServer lmbs)
	    throws NullPointerException, InterceptorCycleException {
	synchronized (lmbs) {
	    MBeanServerInterceptor inter = lmbs.getMBeanServerInterceptor();
     ...
     * from the chain of interceptors in a {@link SunJmxMBeanServer}.
     ...
     */
    public void remove(SunJmxMBeanServer lmbs)
	    throws InterceptorNotPresentException, InterceptorCycleException {
	final String msg = "Interceptor not in SunJmxMBeanServer chain";
