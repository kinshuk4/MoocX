 ...
 * <LI>The default behaviour for periodic notifications is <i>fixed-delay execution</i>, as
...
public class Timer extends NotificationBroadcasterSupport
     ...
     * with the associated date, period and number of occurences.
     */
    ...
    public synchronized void start() {
	    ...
	    timer = new java.util.Timer();
            ...
            // Update the date and the number of occurences of past notifications
...
//                     //
     ...
     *
     * @exception java.lang.IllegalArgumentException The period or the number of occurences is negative
     *
...
//             //
        ...
        if (isTraceOn()) {
            trace("removeNotification", "removing timer notification:" + 
                  ...
                  "\n\tNotification nb of occurences = " + obj[TIMER_NB_OCCUR_INDEX] +
...
// 	       }   
     ...
     * @param id The timer notification identifier.
     *
     * @return A copy of the remaining number of occurences or null if the identifier is not mapped to any 
     * timer notification registered for this timer MBean.
     */
     ...
     * @param id The timer notification identifier.
     *
     * @return A copy of the flag indicating whether a peridic notification is
     *         executed at <i>fixed-delay</i> or at <i>fixed-rate</i>.
     */
    ...
    private synchronized void sendPastNotifications(Date currentDate, boolean currentFlag) {
        ...
        while (e.hasMoreElements()) {
            ...
            while ( (currentDate.after(date)) && (timerTable.containsKey(notifID)) ) {
                ...
                // Update the date and the number of occurences of the timer notification.
                //
     ...
     * <P>
     * If the timer period has a defined number of occurences, the timer 
     * notification is updated if the number of occurences has not yet been reached.
