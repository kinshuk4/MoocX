...
public interface MetaData {
     ...
     *
     * @param object The MBean whose class is to be analyzed.
     *
     ...
     *
     * @param name  The MBean from which the attributes are to be retrieved.
     ...
     *
     * @param name The MBean within which the attributes are to be set.
