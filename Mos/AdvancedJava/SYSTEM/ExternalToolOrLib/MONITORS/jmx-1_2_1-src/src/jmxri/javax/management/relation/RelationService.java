...
public class RelationService extends NotificationBroadcasterSupport
     ...
     * lis which can be null if no role initialization
	...
	String[] ntfTypes = new String[6];
	ntfTypes[0] = RelationNotification.RELATION_BASIC_CREATION;
	ntfTypes[1] = RelationNotification.RELATION_MBEAN_CREATION;
	ntfTypes[2] = RelationNotification.RELATION_BASIC_UPDATE;
	ntfTypes[3] = RelationNotification.RELATION_MBEAN_UPDATE;
	ntfTypes[4] = RelationNotification.RELATION_BASIC_REMOVAL;
	ntfTypes[5] = RelationNotification.RELATION_MBEAN_REMOVAL;
