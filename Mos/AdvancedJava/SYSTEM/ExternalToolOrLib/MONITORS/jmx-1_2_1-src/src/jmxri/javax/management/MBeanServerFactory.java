...
public class MBeanServerFactory {
     ...
     *
     * <p>The standard default domain name is defined in {@link
     * com.sun.jmx.defaults.ServiceName#DOMAIN ServiceName.DOMAIN}.</p>
     *
     ...
     * {@link NullPointerException}.  This behaviour differs from what
     ...
     * If any checked expetion needs to be thrown, it is embedded in
     ...
     * Creates the initial builder according to the 
     * javax.management.builder.initial System property - if specified.
     * If anything goes wrong - security exception, reflection exception,
     * etc... logs an error message and reverts to the default 
     * {@link javax.management.MBeanServerBuilder}.
     **/
//     private static MBeanServerBuilder createInitialBuilder() {
// 	try {
// 	    final String builderClassName = (String)
// 		System.getProperty(JmxProperties.JMX_INITIAL_BUILDER);
// 	    if (builderClassName == null) 
// 		return new MBeanServerBuilder();
// 	    final Class builderClass = loadBuilderClass(builderClassName);
// 	    final Object builder = builderClass.newInstance();
// 	    if (!(builder instanceof MBeanServerBuilder)) throw new 
// 		IllegalArgumentException(builderClassName + 
// 					 " is not a subclass of " +
// 					 "javax.management.MBeanServerBuilder"
// 					 );
// 	    return (MBeanServerBuilder)builder;
// 	} catch (Exception x) {
// 	    error("createInitialBuilder",
// 		  "Failed to instantiate initial MBeanServerBuilder: " + x
// 		  + ". Using defaults.");
// 	    return new MBeanServerBuilder();
// 	}   
//     }
