...
import com.mule.Harness.MyURLClassLoader;

public class AppserverUsingPeerClassLoader {
	...
	public static void main(String[] args) throws Exception {
        ...
        URLClassLoader ejbjarclassloader = new NonDefaultPeerClassLoader("EJBJARCLASSLOADER",ejbjarurl);
        ...
        URLClassLoader webappjarurlclassloader = new NonDefaultPeerClassLoader("WEBAPPJARCLASSLOADER",webappjarurl);
	    ...
	    try{//will throw Linkage Error--Loader Constraint
