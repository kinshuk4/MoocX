...
def fetchNYSEData(dt_start, dt_end, ls_symbols):
    ...
    timestampsForNYSEDays = d_data['actual_close'].index
...
def main():
	...
	initialCash = 100000 #sys.argv[1]
	ordersFilename = "orders1.csv" #sys.argv[2]
	valuesFilename = "values1.csv"  #sys.argv[3]
